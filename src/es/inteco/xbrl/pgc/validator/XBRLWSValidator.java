 ...
 *
 *
 * Clase utilizada para permitir la publicación del servicio de validación a través
 * de un servicio WEB. 
 *
 *
 *<br><br>
...
public class XBRLWSValidator 
{
    ...
    /**
     * 
     * Operación de servicio web encargada de realizar la validación de una instancia XBRL
     * @param inputDocument
     * @return
    ...
    public ValidateResult validate(@WebParam(name = "inputDocument") final byte[] inputDocument)
    {
        ...
        try 
        {
            result = PGCXBRLValidator.createInstance().validate(inputDocument);
