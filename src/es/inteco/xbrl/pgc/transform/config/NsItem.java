 ...
 * Schema.
 * $Id: NsItem.java,v 1.5 2009/01/19 14:12:30 a130499 Exp $
 */
...
public class NsItem implements java.io.Serializable {
     ...
     * es.inteco.xbrl.pgc.transform.config.NsItem
     */
    public static es.inteco.xbrl.pgc.transform.config.NsItem unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.inteco.xbrl.pgc.transform.config.NsItem) org.exolab.castor.xml.Unmarshaller.unmarshal(es.inteco.xbrl.pgc.transform.config.NsItem.class, reader);
    }
