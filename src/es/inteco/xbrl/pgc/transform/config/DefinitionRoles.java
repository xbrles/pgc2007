 ...
 * Schema.
 * $Id: DefinitionRoles.java,v 1.5 2009/01/19 14:12:30 a130499 Exp $
 */
...
public class DefinitionRoles implements java.io.Serializable {
     ...
     * es.inteco.xbrl.pgc.transform.config.DefinitionRoles
     */
    public static es.inteco.xbrl.pgc.transform.config.DefinitionRoles unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (es.inteco.xbrl.pgc.transform.config.DefinitionRoles) org.exolab.castor.xml.Unmarshaller.unmarshal(es.inteco.xbrl.pgc.transform.config.DefinitionRoles.class, reader);
    }
