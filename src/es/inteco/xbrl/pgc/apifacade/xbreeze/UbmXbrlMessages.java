...
public class UbmXbrlMessages implements ISimpleProgressNotify
{

    private ArrayList <IMemo> m_memoList = new  ArrayList<IMemo>();
    
    
    /**
     * Default constructor
     */
    public UbmXbrlMessages() {
		super();
	}
     ...
     * file
     */
    public ArrayList<IMemo> getMemoList()
    {
